...
#define SBI_PROBE_EXTENSION()		SBI_ECALL_0(SBI_EXT_BASE, SBI_BASE_PROBE_EXT)
...
#define SBI_SET_TIMER(VAL)			SBI_ECALL_1(SBI_EXT_SET_TIMER, 0, VAL)
...
char sbi_ecall_console_getchar(void);
