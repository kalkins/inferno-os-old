...
#define INTREGSIZE		4
#define UREGSTART		(0)
#define INTREGSTART		(UREGSTART + 0)
#define TRAPSTACKSIZE	(UREGSIZE)
#define UREGADDR(x)		(x)(R2)
#define INTREG(x)		UREGADDR(INTREGSTART + 4 + (x-1)*INTREGSIZE)
#define UREGCSR(x)		INTREG(x+32)
TEXT traphandler(SB), $-4
